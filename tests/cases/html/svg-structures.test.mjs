...
test('Structure Test: singleton <rect>', t => {
  ...
  forRules(
    [
      ...
      `
      ,
      liquid`{% # rect expressed with self closer %}
      ...
      `
      ,
      liquid`{% # rect expressed with end tag %}
     ...
     `
      ,
      liquid`{% # rect nested within symbol expressed with various %}
...
test('Structure Test: singleton <ellipse>', t => {
  ...
  forRules(
    [
      ...
      `
      ,
      liquid`{% # ellipse expressed with self closer %}
     ...
     `
      ,
      liquid`{% # ellipse nested within symbol expressed with various %}
...
test('Structure Test: singleton <stop>', t => {
  ...
  forRules(
    [
      ...
      `
      ,
      liquid`{% # ellipse expressed with self closer and ender %}
...
test('Convert and correct singletons to self closing tokens', t => {
  ...
  forAssert([
    [
      ...
      liquid`{% # apply self closing forward slashes %}
