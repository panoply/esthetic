...
test('Ignore Region (Block Comment) - Newlines and indentation', async t => {
...
test('Ignore Region (Block Comment) - Edge cases', async t => {
...
test('Ignore Region (Block Comment) - Followed by markup', async t => {
...
test('Ignore Region (Block Comment) - Followed by liquid', async t => {
