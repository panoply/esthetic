# Snapshot report for `tests/cases/liquid/ignore-next.test.mjs`
...
## Ignore Next (Line Comment) - Newlines and indentation
...
## Ignore Next (Line Comment) - Edge cases
...
## Ignore Next (Line Comment) - Followed by markup
...
## Ignore Next (Line Comment) - Followed by liquid
